module.exports = {
	...
	execute(message, args, moderatore){
		...
		if((caller.id === 18 || caller.id === 10) && caller.alive){ //check if he's roleID: 18
					
					
			if((!called.alive && caller.id === 18) || (called.alive && caller.id === 10)){ //check if the numbe 18 is checking someone alive and number 10 someone dead
